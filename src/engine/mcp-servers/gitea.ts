      ...
      },
      {
        ...
        inputSchema: {
          ...
          properties: {
            ...
            license: { type: 'string', description: 'License template name, e.g. Elastic-2.0, MIT' },
          },
          required: ['name'],
        },
      },
