...
export class AdobeSignMCPServer extends MCPAdapterBase {
  ...
  private async apiPut(path: string, body: Record<string, unknown>): Promise<ToolResult> {
    ...
    const result: unknown = text ? JSON.parse(text) as unknown : { success: true };
