...
- **Live customer breakage in 2.1.1 resolved.** The native binary's accept-list now includes the current production license-signing public key. Customers on `@epicai/chariot@2.1.1` have been unable to validate licenses signed after 2026-04-30; upgrading to 3.0.0 restores validation. Tracked as [CHARIOT-2026-002](SECURITY.md#chariot-2026-002--300-license-signing-key-rotation-2026-04-30).
...
- A GitHub Security Advisory documents a credential-scoped finding that affected versions prior to 2.0.0. A second advisory ([CHARIOT-2026-002](SECURITY.md#chariot-2026-002--300-license-signing-key-rotation-2026-04-30)) covers the 2.1.1 license-validation regression resolved here.
